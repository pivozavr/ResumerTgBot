...
async def resume_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    Проанализируй историю переписки и составь краткое структурированное резюме.

Параметры анализа:
Уровень подробности: {difs[dif_id]}.
...
{messages}""")
    ...
    text = text.replace("<b>Основные тезисы участников:</b>", "<blockquote expandable><b>Основные тезисы участников:</b>")
    text = text.replace("\n<b>Итог обсуждения:</b>", "</blockquote>\n<b>Итог обсуждения:</b>")
